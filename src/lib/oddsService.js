const { apiFootballGet } = require("./apiFootball");
const { getFromCache, setInCache } = require("./cache");
const { getMarketCode, getSelectionCode } = require("./markets");
...
async function getFixtureOdds(fixtureId, skipCache = false) {
...
async function fetchOddsForDate(date, timezone = "Africa/Addis_Ababa", forceRefresh = false) {
...
async function streamOddsForDate(
    date,
