...
import { fetchOddsForDate, getFixtureOdds, streamOddsForDate } from "../lib/oddsService";
...
router.get("/", async (req, res) => {
    try {
        const date = req.query.date as string || new Date().toLocaleDateString("en-CA", { timeZone: "Africa/Addis_Ababa" });
