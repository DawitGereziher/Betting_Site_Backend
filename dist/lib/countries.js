...
exports.COUNTRY_PRIORITY = void 0;
exports.getCountryFlagPath = getCountryFlagPath;
exports.getCountryFlag = getCountryFlag;
exports.getCountryPriority = getCountryPriority;
exports.sortCountriesByPriority = sortCountriesByPriority;
// Country ordering by popularity
exports.COUNTRY_PRIORITY = {
    England: 1,
    "Champions League": 2,
    "Europa League": 3,
    Spain: 4,
...
function getCountryPriority(country) {
    // Check exact match
    if (exports.COUNTRY_PRIORITY[country] !== undefined) {
        return exports.COUNTRY_PRIORITY[country];
    }
    ...
    if (lowerCountry.includes("champions league") || lowerCountry.includes("uefa champions")) {
        return exports.COUNTRY_PRIORITY["Champions League"];
    }
    if (lowerCountry.includes("europa league") || lowerCountry.includes("uefa europa")) {
        return exports.COUNTRY_PRIORITY["Europa League"];
    }
    if (lowerCountry.includes("world cup")) {
        return exports.COUNTRY_PRIORITY["World Cup"];
    }
    if (lowerCountry.includes("european championship") || lowerCountry.includes("euro")) {
        return exports.COUNTRY_PRIORITY["European Championship"];
    }
    // Check partial matches for countries
    for (const [key, priority] of Object.entries(exports.COUNTRY_PRIORITY)) {
