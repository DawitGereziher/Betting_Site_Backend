...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const res = yield (0, apiFootball_1.apiFootballGet)("/fixtures", params, 60000, true);
            ...
            for (const tc of testCases) {
                const result = (0, resultChecker_1.checkItemResult)("UNKNOWN", // Force derivation
                "UNKNOWN", tc.line, fixture, 1.50, tc.market, tc.selection);
                output.tests.push(Object.assign(Object.assign({}, tc), { result }));
            }
